                ...
                <section className='homesection'>
                    <div className='sectiondiv'>
                        ...
                        <div className="writer">
                            ...
                            <Typewriter options={{
                                strings: ["A Designer...", "A Video Editor...", "A Graphic Designer...","A Digital Marketer..."],
                                autoStart: true,
                                loop: true,
                        ...
                        <aside>
                            <div>
                                ...
                                <article>
                                    <p>+
                                        <motion.span ref={projectCount} whileInView={animationProjectsCount}>250</motion.span>
                                    </p>
